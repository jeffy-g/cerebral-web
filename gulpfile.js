...
//
/** ts compiled out put. */
const JS_DEST_DIR = "./docs";
const SRC_DIR = "./src";

const SCSS_ROOT = `${SRC_DIR}/css`;
/** copy transpiled code for dist package. */
const COPY_FILEs = [
    `${SRC_DIR}/**/{main.css*,style.css,react-table.css,*.jpg}`,
    `${SRC_DIR}/**/!(jquery).js`,
...
// gulp zip --file ./docs/webpack.js --comment "this is test"
gulp.task("zip", done => {
 ...
 * 
 *  gulp pug [--electron --pugOutDir ../eve-cerebral-app.bitbucket.io]
 * 
 ...
 * #### compile sass file.
 * 
 *  node ./etc/build-tool -cmd sass [-destDir ../eve-cerebral-app.bitbucket.io/css]
 * 
